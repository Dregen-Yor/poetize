...
<template>
  <div>
    ...
    <Transition name="el-fade-in-linear">
      <!-- 导航栏 -->
      <div v-show="toolbar.visible || ($common.mobile() || mobile ||console.log($common))" @mouseenter="hoverEnter = true"
        @mouseleave="hoverEnter = false"
        :class="[{ enter: toolbar.enter }, { hoverEnter: (hoverEnter || router.path === '/favorite' || router.path === '/travel') && !toolbar.enter }]"
    ...
    <div class="toolButton">
      ...
      <el-popover placement="left" :hide-after="500" trigger="hover">
        <template #reference>
        ...
        <div class="my-setting">
          <div>
            ...
            <el-icon v-if="isDark" class="iconRotate" @click="changeColor()" :size="33"><Sunny/></el-icon>
            <!-- 月亮按钮 -->
            <i v-else class="fa fa-moon" aria-hidden="true" @click="changeColor()"></i>
          </div>
          <div>
            <i class="fa fa-snowflake" aria-hidden="true" @click="changeMouseAnimation()"></i>
          </div>
        </div>
      </el-popover>
    </div>
    ...
    <el-drawer v-model="toolbarDrawer" :show-close="false" size="65%" custom-class="toolbarDrawer" header="欢迎光临"
      direction="ltr">
      <div>
        <ul class="small-menu">
...
export default {
  ...
  computed: {
    ...
    sortInfo() {
      console.log(this.$store.state.sortInfo);
