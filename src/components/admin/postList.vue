<template>
  <div>
    ...
    <el-table :data="articles" border class="table" header-cell-class-name="table-header">
      ...
      <el-table-column prop="username" label="作者" style="align-items: center;"></el-table-column>
      <el-table-column prop="articleTitle" label="文章标题" style="align-items: center;"></el-table-column>
      <el-table-column prop="sort.sortName" label="分类" style="align-items: center;"></el-table-column>
      <el-table-column prop="label.labelName" label="标签" style="align-items: center;"></el-table-column>
      <el-table-column prop="viewCount" label="浏览量" style="align-items: center;"></el-table-column>
      <el-table-column prop="likeCount" label="点赞数" style="align-items: center;"></el-table-column>
      <el-table-column label="是否可见" style="align-items: center;">
      ...
      <el-table-column label="封面" style="align-items: center;">
        <template slot-scope="scope">
          <el-image lazy class="table-td-thumb" :src="scope.row.articleCover" fit="cover"></el-image>
        </template>
      </el-table-column>
      <el-table-column label="是否启用评论" style="align-items: center;">
        <template slot-scope="scope">
      ...
      <el-table-column label="是否推荐" style="align-items: center;">
        <template slot-scope="scope">
      ...
      <el-table-column prop="commentCount" label="评论数" style="align-items: center;"></el-table-column>
