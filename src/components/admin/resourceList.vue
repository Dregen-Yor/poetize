  ...
  <div>
    <div>
      ...
      <el-table :data="resources" border class="table" header-cell-class-name="table-header">
        ...
        <el-table-column prop="originalName" label="名称" style="align-items: center;"></el-table-column>
        ...
        <el-table-column label="路径" style="align-items: center;">
          <template slot-scope="scope">
        ...
        <el-table-column label="大小(KB)" style="align-items: center;">
          <template slot-scope="scope">
            {{Math.round(scope.row.size / 1024)}}
          </template>
        </el-table-column>
        <el-table-column prop="mimeType" label="类型" style="align-items: center;"></el-table-column>
        <el-table-column prop="storeType" label="存储平台" style="align-items: center;"></el-table-column>
