<template>
  <div>
    ...
    <el-table :data="comments" class="table" header-cell-class-name="table-header">
      <el-table-column prop="id" label="ID" width="55" style="align-items: center;"></el-table-column>
      <el-table-column prop="source" label="评论来源标识" style="align-items: center;"></el-table-column>
      <el-table-column prop="type" label="评论来源类型" style="align-items: center;"></el-table-column>
      <el-table-column prop="userId" label="发表用户ID" style="align-items: center;"></el-table-column>
      <el-table-column prop="likeCount" label="点赞数" style="align-items: center;"></el-table-column>
      <el-table-column prop="commentContent" label="评论内容" style="align-items: center;"></el-table-column>
      <el-table-column prop="commentInfo" label="评论额外信息" style="align-items: center;"></el-table-column>
