<template>
  <div>
    ...
    <el-table :data="sortInfo" border class="table" header-cell-class-name="table-header">
      ...
      <el-table-column prop="sortName" label="分类名称" style="align-items: center;"></el-table-column>
      <el-table-column prop="sortDescription" label="分类描述" style="align-items: center;"></el-table-column>
      <el-table-column label="分类类型" style="align-items: center;">
        <template slot-scope="scope">
          <span v-if="scope.row.sortType === 0">导航栏分类</span>
          <span v-else-if="scope.row.sortType === 1">普通分类</span>
        </template>
      </el-table-column>
      <el-table-column prop="priority" label="分类优先级" style="align-items: center;"></el-table-column>
      <el-table-column prop="countOfSort" label="文章总数" style="align-items: center;"></el-table-column>
      <el-table-column label="操作" width="380" style="align-items: center;">
        <template slot-scope="scope">
    ...
    <el-table v-if="!$common.isEmpty(sort)" :data="sort.labels" border class="table"
      ...
      <el-table-column prop="id" label="ID" width="55" style="align-items: center;"></el-table-column>
      <el-table-column label="分类名称" style="align-items: center;">
        <span>{{sort.sortName}}</span>
      </el-table-column>
      <el-table-column prop="labelName" label="标签名称" style="align-items: center;"></el-table-column>
      <el-table-column prop="labelDescription" label="标签描述" style="align-items: center;"></el-table-column>
      <el-table-column prop="countOfLabel" label="文章总数" style="align-items: center;"></el-table-column>
      <el-table-column label="操作" width="320" style="align-items: center;">
        <template slot-scope="scope">
