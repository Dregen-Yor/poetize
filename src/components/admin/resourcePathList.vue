  ...
  <div>
    <div>
      ...
      <el-table :data="resourcePaths" border class="table" header-cell-class-name="table-header">
        ...
        <el-table-column prop="title" label="标题" style="align-items: center;"></el-table-column>
        <el-table-column prop="classify" label="分类" style="align-items: center;"></el-table-column>
        ...
        <el-table-column prop="url" label="链接" style="align-items: center;"></el-table-column>

        <el-table-column prop="type" label="资源类型" style="align-items: center;"></el-table-column>
        ...
        <el-table-column prop="remark" label="备注" style="align-items: center;"></el-table-column>
