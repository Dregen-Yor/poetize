<template>
  <div>
    ...
    <el-table :data="configList" height="75vh" border class="table" header-cell-class-name="table-header">
      ...
      <el-table-column prop="configName" label="名称" style="align-items: center;"></el-table-column>
      <el-table-column prop="configKey" label="键名" style="align-items: center;"></el-table-column>
      <el-table-column prop="configValue" label="键值" style="align-items: center;"></el-table-column>
      <el-table-column label="类型" style="align-items: center;">
        <template slot-scope="scope">
          <span v-if="scope.row.configType === '1'">私有</span>
          <span v-else-if="scope.row.configType === '2'">公开</span>
        </template>
      </el-table-column>
      <el-table-column label="操作" width="200" style="align-items: center;">
        <template slot-scope="scope">
